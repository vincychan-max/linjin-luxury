      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="border-b border-white/10 pb-12 mb-12 text-center">
          <h2 className="text-lg md:text-2xl font-light tracking-[0.3em] uppercase mb-4 opacity-90">
            Premium Supply Chain Specialists
          </h2>
          <p className="max-w-2xl mx-auto text-[13px] md:text-base opacity-50 leading-relaxed italic px-4">
            "Crafted with exceptional quality and timeless design, delivered with precision from our studio to your wardrobe."
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-y-12 md:gap-12 mb-20">
          ...
          <nav aria-label="Services navigation" className="text-center md:text-left">
            ...
            <ul className="space-y-4 text-[13px] opacity-70">
              {['FAQ', 'Authenticity Verification', 'Contact', 'Shipping & Returns', 'Product Care'].map((item) => (
                <li key={item}>
                  <Link href={`/${item.toLowerCase().replace(/ /g, '-')}`} className="hover:opacity-100 transition-opacity block py-1">
                    {item}
                  </Link>
                </li>
              ))}
          ...
          <nav aria-label="Collection navigation" className="text-center md:text-left">
            ...
            <ul className="space-y-4 text-[13px] opacity-70">
              <li><Link href="/collection/shoulder-bags" className="hover:opacity-100 transition-opacity block py-1">Shoulder Bags</Link></li>
              <li><Link href="/collection/tote-bags" className="hover:opacity-100 transition-opacity block py-1">Tote Bags</Link></li>
              <li><Link href="/collection/clutch-bags" className="hover:opacity-100 transition-opacity block py-1">Clutch Bags</Link></li>
              <li><Link href="/collection/crossbody-bags" className="hover:opacity-100 transition-opacity block py-1">Crossbody Bags</Link></li>
              <li><Link href="/collection" className="hover:opacity-100 transition-opacity underline underline-offset-4 block py-1">Discover All</Link></li>
            </ul>
          </nav>
...
<nav aria-label="About navigation" className="text-center md:text-left">
  ...
  <ul className="space-y-4 text-[13px] opacity-70">
    <li>
      <Link href="/about" className="hover:opacity-100 transition-opacity block py-1">
        Our Workshop
      </Link>
    </li>
    <li>
      <Link href="/journal" className="hover:opacity-100 transition-opacity block py-1">
        The Journal
      </Link>
    </li>
    <li>
      <Link href="/bespoke" className="hover:opacity-100 transition-opacity block py-1">
        Bespoke Service
      </Link>
    </li>
    <li>
      <Link href="/sustainability" className="hover:opacity-100 transition-opacity block py-1">
        Sustainability
      </Link>
    </li>
  ...
  <Link href="/sitemap" className="hover:opacity-100 transition-opacity block py-1 text-[11px] opacity-40 uppercase tracking-widest mt-4">
    Sitemap
          ...
          <div className="flex flex-col text-center md:text-left">
            ...
            <p className="text-[13px] opacity-60 mb-8 leading-relaxed px-4 md:px-0">
              Subscribe to receive updates on new arrivals and exclusive supply chain insights.
            </p>
            ...
            <div className="flex flex-wrap gap-6 mt-10 justify-center md:justify-start items-center">
              <a href="https://instagram.com/linjinluxury" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
              ...
              <a href="https://x.com/linjinluxury" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform text-white">
              ...
              <a href="https://tiktok.com/@linjinluxury" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform text-white">
              ...
              <a href="https://facebook.com/linjinluxury" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform" style={{ color: '#1877F2' }}>
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://linkedin.com/company/linjinluxury" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform" style={{ color: '#0A66C2' }}>
              ...
              <a href="https://youtube.com/@linjinluxury" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform" style={{ color: '#FF0000' }}>
        ...
        {/* --- 底部版权与全球布局：优化响应式排列 --- */}
        <div className="border-t border-white/5 pt-10 flex flex-col md:flex-row justify-between items-center text-[10px] tracking-[0.2em] uppercase opacity-40 font-medium text-center md:text-left">
          <p className="mb-8 md:mb-0">© {currentYear} Linjin Luxury. Supply Chain Specialists.</p>
          
          <div className="flex flex-wrap justify-center md:justify-end gap-x-4 gap-y-3 max-w-[300px] md:max-w-none">
            <span className="text-white opacity-100">China</span>
